...
/* 
 	Reader / Writer    : char 단위 입출력. 문자만 처리 하록 특화된 추상클래스 
 		엔코딩의 신경을 덜 써도 된다. 
 		//byte : 1byte
 		//char : 2byte , UTF-16 (유니코드) 로 처리, 영문 2byte, 한글도 2byte, 고정길이, 전 세계 모든 언어를 처리 	
 		 
 		 FileReader : charset지정 옵션이 없다. default charset 사용
 		 FileWriter : charset지정 옵션이 없다. default charset 사용
 */
